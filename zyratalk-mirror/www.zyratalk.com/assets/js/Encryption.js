...
function encryptStr(input){
    let encryption = new Encryption();
    var encrypted = encryption.encrypt(input, "eyJjaXBoZXJ0ZXh0IjoiNkRuSzRueVR5aERIQTVCdkF6SU9Mc0E0S1llUW5tZndvS0hIb");
    return encrypted;
}

function decryptStr(input){
    let encryption = new Encryption();
    var decrypted = encryption.decrypt(input, "eyJjaXBoZXJ0ZXh0IjoiNkRuSzRueVR5aERIQTVCdkF6SU9Mc0E0S1llUW5tZndvS0hIb");
    return decrypted;
}